...
initial_z = np.load('./data/initial_z_custommaze_roll45000.5z32.ckpt.npz')
# initial_z = np.load('./data/initial_z_v10000.10rand3ckpt.npz')
...
class EasyMazeDream(gym.Env):
    ...
    def reset_obs(self):
      a= np.zeros(self.model.input_size)
      return a
