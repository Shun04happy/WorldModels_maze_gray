...
ROOT_DIR_NAME = "./data/"
ROLLOUT_DIR_NAME = "./data/custom2dmaze_rollout4/"
SERIES_DIR_NAME = "./data/custom2dmaze_series_roll4/"
...
def main(args):
    ...
    np.savez_compressed(ROOT_DIR_NAME + 'initial_z_custommaze_roll45000.5z32.ckpt.npz', initial_mu=initial_mus, initial_log_var=initial_log_vars)#(10000, 32)
