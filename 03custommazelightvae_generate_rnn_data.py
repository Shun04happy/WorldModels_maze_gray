...
ROOT_DIR_NAME = "./data/"
ROLLOUT_DIR_NAME = "./data/custom2dmaze_light2/"
...
def main(args):
    ...
    try:
      ...
      vae.set_weights('./vae/vae_weights/weights_custommaze_light2.5000.10z32k3conv1r100000.ckpt')
    ...
    np.savez_compressed(ROOT_DIR_NAME + 'initial_z_custommaze_light2.5000.10z32k3conv1r100000.ckpt.npz', initial_mu=initial_mus, initial_log_var=initial_log_vars)#(10000, 32)
