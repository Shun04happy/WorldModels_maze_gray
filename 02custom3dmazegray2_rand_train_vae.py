...
DIR_NAME = './data/custom3dmaze_gray2_rand/'
...
def main(args):
  ...
  vae = VAE()
  checkpoint_path=f'./vae/vae_weights/weights_custom3dmaze_gray2_rand{N}.{epochs}z32k3conv1r100000lr0001.ckpt'
    ...
    for i in range(loadnum):
      if not new_model:
        try:
          ...
          vae.set_weights(f'./vae/vae_weights/weights_custom3dmaze_gray2_rand{N}.{epochs}z32k3conv1r100000lr0001.ckpt')
      ...
      vae.save_weights(f'./vae/vae_weights/weights_custom3dmaze_gray2_rand{N}.{epochs}z32k3conv1r100000lr0001.ckpt')
