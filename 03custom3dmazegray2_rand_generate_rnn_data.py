...
ROOT_DIR_NAME = "./data/"
ROLLOUT_DIR_NAME = "./data/custom3dmaze_gray2/"
...
def main(args):
    ...
    try:
      ...
      print(e)
      print("./vae/vae_weights/weights_custom3dmaze_gray2_rand5000.10z32k3conv1r100000lr0001.ckpt does not exist - ensure you have run 02_train_vae.py first")
      raise
    ...
    np.savez_compressed(ROOT_DIR_NAME + 'initial_z/initial_z_custom3dmaze_gray2.5000.10z32k3conv1r100000lr0001.ckpt.npz', initial_mu=initial_mus, initial_log_var=initial_log_vars)#(10000, 32)
