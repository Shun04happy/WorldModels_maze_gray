...
from vae.arch_custommazegray2z32flat import VAE
import argparse
import numpy as np
import config
import os
...
def main(args):
  ...
  vae = VAE()
  checkpoint_path=f'./vae/weights_custommaze_gray2{N}.{epochs}z32flat.ckpt'
  ...
  vae.save_weights(f'./vae/vae_weights/weights_custommaze_gray2{N}.{epochs}z32flat.ckpt')
